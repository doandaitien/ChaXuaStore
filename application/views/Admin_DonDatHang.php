...
<head>
	...
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
 	...
 	<link rel="stylesheet" type="text/css" href="<?= base_url();?>vendor/Css/Admin_DonDatHang.css">
 	<script type="text/javascript" src="<?= base_url();?>vendor/Js/Admin_QlyDonDatHang.js"></script>
				...
				<div id="abc" >
					...
					<div class="list-menu">
						<ul >
							...
							<li>
								<a href="<?php echo base_url(); ?>Admin/quanLyDonDatHang" class="menuchinh visitted">
			...
			<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 noidungchinh">
				...
				<div class="list-product">				
					<div class="container">
						...
						<div class="timkiem">
							<input class="form-control" type="text" placeholder="Nhập mã đơn" aria-label="Search" id="search-key">
						...
						<div class="danhsachhoadon">
							<table class="table">
								...
								<tbody class="body">
									...
									<?php foreach($dulieudondathang as $key => $value):?>
									<tr class="hoadon">
										<td>HD<?= $value['OID']?></td>
										<td><?= $value['code']?></td>
										<td><?= $value['time']?></td>
									...
									<tr class="chitietdonhang" >
										<td colspan="4">
											...
											<div class="chitiet form-wrapper">
												<div class="row">
													<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
														<div class="form-group form-control">
															<label for="" class="form-label control-label ">Mã đơn hàng:</label>
															<strong>HD<?= $value['OID']?></strong>
														</div>
														<fieldset disabled>
															<div class="form-group form-control">
														...
														<table class="table">
															...
															<tbody class="body">
																...
																<tr>
																	...
																	<td align="right"><?= $value1['amount']?></td>
																	<td align="right"><?= number_format($value1['price'])?></td>
																	<td align="right"><?= $value1['namet']?></td>
																	<td align="right"><?= number_format($value1['totalpriceItem'])?></td>
																</tr>
																<?php endforeach ?>
															</tbody>
														</table>
																...
																<table class="table" cellspacing="0" cellpadding="0">
																	<tbody>
																		<tr>
																			...
																			<td align="right"><?= $value['sumAmount']?></td>														
																		</tr>
																		<tr>
																		...
																		<tr>
																			...
																			<td align="right"><?= number_format($value['totalprice'] - $value['totalpriceafter'])?></td>
																		</tr>
																		<tr>
																			<td align="right">Khách cần trả:</td>
																			<td align="right"><?= number_format($value['totalpriceafter'])?></td>
																		</tr>
																	</tbody>
																</table>
															</div>
												...
												<!-- phần nút bấm -->
												<div class="nut">
													<p class="OID" hidden="true"><?= $value['OID']?></p>
													<a href="" class="btn btn-default print">In<i class="fas fa-print"></i></a>
													<a class="btn btn-default browser">Duyệt<i class="fas fa-pencil-alt"></i> </a>
									...
									<tr class="text-center">
										<td colspan="4"><h3>Không có đơn hàng cần Kiểm duyệt</h3></td>
									</tr>
									<?php } ?>
